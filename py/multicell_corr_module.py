...
nNeurons = 512                       # Sizes of populations of grid cells to be tested
...
def multicorr_plotter():
    ...
    for i in range(3):
        multicorr_fig( axs[3+i], spacingStd=spacingStds[i], gausswidth=0.3 )
    for i in range(3):
        multicorr_fig( axs[6+i], spacingStd=spacingStds[i], gausswidth=0.4 )
